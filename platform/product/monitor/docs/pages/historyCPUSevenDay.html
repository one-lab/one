...
<div id="layout_center">
  <div class="main" style="margin-bottom:60px;">
     <div class="threshold_file">
          ...
          <div class="sub_title">最近7天的每小时CPU利用率 </div>
          ...
          <table class="base_info" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr><td colspan="2"> 
            	<div class="days_data">
                  <a href="historyCPUThirtyDay.html"><div class="thirty_days"></div></a>
                  <a href="#"><div class="seven_days_unable"></div></a>
                </div></td></tr>
     ...
     <div class="threshold_file">
       <div class="sub_title">CPU利用率(%)</div>
