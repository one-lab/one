                                        ...
                                        <c:forEach items="${applicationIndexViewModels}"
                                            ...
                                            <tr class="p_info_table_body">
                                                ...
                                                <td class="body"><a
                                                    ...
                                                    &nbsp;<a
                                                            href="${ctx}/application/manager/bsmanager/update/${applicationIndexViewModel.applicationId}">编辑</a>
                                                    &nbsp;<a
                                                            href="${ctx}/application/manager/bsmanager/delete/${applicationIndexViewModel.applicationId}">删除</a>
