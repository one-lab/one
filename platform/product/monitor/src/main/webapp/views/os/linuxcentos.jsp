        ...
        <tr>
          <td width="100%" align="center" class="dashboard"><table width="100%" cellspacing="0" cellpadding="0" border="0">
              <tbody>
                ...
                <tr>
                  <td id="respondTime" align="center" class="textResponseTime" colspan="1"> </td>
              ...
              <tbody>
                <tr>
                  <td width="100%" align="center" class="dashboard"><table width="99%" cellspacing="0" cellpadding="3" border="0">
                      <tbody >
                        <tr>
                          <td id="cpuUtilzation1" height="28" align="center" title="CPU使用率-3 %" class="bodytext" colspan="1"><a href="#" class="speed" onclick='viewWindowCPU(this)'><div id="cpuUtilzation" style="width: 200px; height: 140px; margin: 0 auto; "></div></a></td>
                        </tr>
                        <tr>
                          <td  align="center" class="bodytextbold"><a id="cpuUtilzation2" class="staticlinks" onclick='viewWindowCPU(this)' href="javascript:void(0)">CPU使用率 - 3</a> % </td>
                        </tr>
                      </tbody>
                    </table></td>
                </tr>
              ...
              <tbody>
                <tr>
                  <td width="100%" align="center" class="dashboard"><table cellspacing="0" cellpadding="3" border="0">
                      <tbody>
                        <tr>
                          <td id="ramUtilzation1" height="28" align="center" title="内存使用率-16 %" class="bodytext" colspan="1"><a href="#" class="speed2" onclick='viewWindowNC'><div id="ramUtilzation" style="width: 200px; height: 140px; margin: 0 auto"></div></a></td>
                        </tr>
                        <tr>
                          <td  align="center" class="bodytextbold"><a id="ramUtilzation2" class="staticlinks" onclick='viewWindowNC(this)' href="javascript:void(0)">内存使用率-16</a> % </td>
                        </tr>
                      </tbody>
                    </table>
              ...
              <tbody>
                <tr>
                  <td width="100%" align="center" class="dashboard"><table cellspacing="0" cellpadding="3" border="0">
                      <tbody>
                        <tr>
                          <td id="diskUtilzation1" height="28" align="center" title="磁盘利用率-12%" class="bodytext" colspan="1"><a href="#" class="speed3" onclick='viewWindowCP(this)'><div id="diskUtilzation" style="width: 200px; height:140px; margin: 0 auto"></div></a></td>
                        </tr>
                        <tr>
                          <td  align="center" class="bodytextbold"><a id="diskUtilzation2"  onclick='viewWindowCP(this)' class="staticlinks"  href="javascript:void(0)">磁盘使用率-12</a> %</td>
                        </tr>
                      </tbody>
                    </table>
