...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript"
			src="${ctx}/global/js/sinosoft.window.js"></script>
		<script language="javascript"
			src="${ctx}/global/js/sinosoft.message.js"></script>
		...
		<script language="javascript" src="${ctx}/views/os/HighchartsTest.js"></script>
	</head>
	<body>
