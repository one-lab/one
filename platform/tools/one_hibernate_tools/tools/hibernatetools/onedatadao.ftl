...
public interface ${declarationName}Dao extends ${pojo.importType("org.springframework.data.repository.CrudRepository")}<${declarationName}, ${pojo.getJavaTypeName(clazz.identifierProperty, true)}> {
}
</#assign>
