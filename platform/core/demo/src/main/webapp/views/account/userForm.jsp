...
<%@ taglib prefix="msg" uri="/WEB-INF/errorMsg.tld" %>
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<msg:errorMsg property="loginName" />
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<msg:errorMsg property="password" type="message" />
				</div>
			</div>
			<div class="control-group">
