  ...
  <body>
	...
	<div style = "width:100%">
		...
		<table id="ApplyButtonInfo" class="common" cellpadding="3" cellspacing="0">
			...
			<tr>
				<td colspan="6" >请输入补打原因</td>
			</tr>
			<tr>
				<td colspan="3"><textarea id="clmHistory"  name="lcRepInfo.clmHistory" cols="100%" rows="5"></textarea><img src="${ctx}/images/bgMarkMustInput.jpg" ></td>
			</tr>
			<tr>
				<td><input type = "button" class="cssbutton" name="ApplyButton" value="补打批单" onclick=""></td>
			</tr>
		</table>
	</div>
	</form>
