	...
	<div style = "width:100%">
		...
		<table id="ApplyButtonInfo" class="common" cellpadding="3" cellspacing="0">
			<tr>
				...
				<td class="right"><input name="BussType" class="common" type="text"><img src="${ctx}/images/bgMarkMustInput.jpg" ></td>
				<td class="common"></td>
				<td class="common"></td>
				<td class="common"></td>
				<td class="common"></td>
			...
			<tr>
				<td><input type = "button" class="cssbutton" name="ApplyButton" value="打印批单" onclick=""></td>
			</tr>
		</table>
	</div>
	</form>
