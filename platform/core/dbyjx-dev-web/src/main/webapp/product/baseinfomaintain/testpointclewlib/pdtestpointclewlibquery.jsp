	...
	<div style = "width:100%">
			...
			<thead>
				...
				<tr class="tableHead">
					<td width="5%">&nbsp;</td>
					<td width="5%">序号</td>
					<td width="18%">产品基础表名称</td>
					<td width="18%">产品基础表代码</td>
					<td width="18%">产品基础字段名称</td>
					<td width="18%">产品基础字段代码</td>
					<td width="18%">测试要点提示内容</td>
				</tr>
			</thead>
			<tbody>
				<tr class="content">
		...
		<table id="" class="common" cellpadding="3" cellspacing="0">
			<tr>
				<td colspan="8" align="center">
					...
					<input type = "button" class="cssbutton" name="SaveButton" value="新  增" onclick="location.href='pdtestpointclewlibview.jsp'">
				</td>
			</tr>
		</table>
		</div>
