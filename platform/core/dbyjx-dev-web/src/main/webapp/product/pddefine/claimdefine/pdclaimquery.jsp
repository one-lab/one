		...
		<table id="QueryApplingRiskInfo" class="common" cellpadding="3" cellspacing="0">
			<tr>
				<td class="formtitle" colspan="4">
					...
					<%-- flag等于4表示是理赔部分做的查询 ；--%>
			    <td class="right"><input name="flag" value="4" type="hidden"></td>
			...
			<tr>
				...
				<td class="right">
					<input name="pdLMRisk.makeDate" id="makeDate" class="common" type="text"  style="width: 73%" value='<s:date name="makeDate" format="yyyy-MM-dd"/>'/>
