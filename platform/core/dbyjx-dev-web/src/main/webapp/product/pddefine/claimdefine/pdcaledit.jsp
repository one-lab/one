...
<html>
  ...
  <body>
	...
	<div style="width:100%">	
		...
		<table id="" class="common" cellpadding="3" cellspacing="0">
			<thead>
				...
				<tr class="tableHead" align="center">
					...
					<td width="10%">要素代码</td>
					<td width="10%">测试值</td>
					<td width="20%">要素值数据类型</td>
					<td width="20%">要素含义说明</td>
				</tr>
			</thead>
			<tbody align="center">
				<tr class="content">
		...
		<table>
			<tr>
				<td class="formtitle" colspan="5"><img src="${ctx}/images/bgformtitle.gif" style="cursor:hand;">添加自定义子算法</td>
			</tr>
			<tr>
				...
				<td class="right"><input name="" class="common" type="text"/></td>
				<td><input type = "button" class="cssbutton" name="Button" value="添加" onclick=""></td>
			</tr>		
		</table>
		<table id="" class="common" cellpadding="3" cellspacing="0">
			<thead>
				<tr>
					<td class="formtitle" colspan="7"><img src="${ctx}/images/bgformtitle.gif" style="cursor:hand;">子算法说明</td>
				</tr>
				<tr class="tableHead" align="center">
					<td width="5%">&nbsp;</td>
					<td width="5%">序号</td>
			...
			<table id="" class="common" cellpadding="3" cellspacing="0">
				<tr>
					<td><input type = "button" class="cssbutton" name="Button" value="子算法属性定义" onclick="location.href='pdchildcaledit.jsp'"></td>
