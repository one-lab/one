  ...
  <body>
	...
	<div style = "width:100%">
		<table id="scanQueryInfo" class="common" cellpadding="3" cellspacing="0">
			<tr>
				<td class="formtitle" colspan="6"><img src="${ctx}/images/bgformtitle.gif" style="cursor:hand;">     请输入投保单查询条件</td>
			</tr>
			<tr>
				<td class="left">通知书类型：</td>
		...
		<table id="PublicInfo" class="common" cellpadding="3" cellspacing="0">
			<thead>
				<tr>
					<td class="formtitle" colspan="6"><img src="${ctx}/images/bgformtitle.gif" style="cursor:hand;">     通知书信息</td>
				</tr>
				<tr class="tableHead">
					<td width="3%">&nbsp;</td>
					<td width="5%">序号</td>
					<td width="17%">流水号</td>
					<td width="15%">投保单号码</td>
					<td width="15%">业务员号</td>
					<td width="15%">业务员姓名</td>
					<td width="15%">营销服务部</td>
					<td width="15%">发送日期</td>					
				</tr>
			</thead>
			<tbody>
		...
		<table id="ApplyButtonInfo" class="common" cellpadding="3" cellspacing="0">
			<tr>
				<td colspan="6">
					<input type = "button" class="cssbutton" name="ApplyButton" value="打  印" onclick="">
				</td>
			</tr>
		</table>
	</div>
