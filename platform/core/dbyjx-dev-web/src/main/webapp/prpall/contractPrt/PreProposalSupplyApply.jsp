  ...
  <body>
	...
	<div style = "width:100%">
		...
		<table id="PublicInfo" class="common" cellpadding="3" cellspacing="0">
			<thead>
				<tr>
					<td class="formtitle" colspan="6"><img src="images/bgformtitle.gif" style="cursor:hand;">     集体信息</td>
				</tr>
				<tr class="tableHead">
					<td width="3%">&nbsp;</td>
					<td width="5%">序号</td>
					<td width="15%">集体投保单号码</td>
					<td width="15%">集体合同号码</td>
					<td width="15%">投保单位客户号</td>
					<td width="17%">投保单位名称</td>
					<td width="15%">管理机构</td>
					<td width="15%">代理人编码</td>
				</tr>
			</thead>
			<tbody>
				<tr class="content">
		...
		<table id="ApplyButtonInfo" class="common" cellpadding="3" cellspacing="0">
			<tr>
				<td><input type = "button" class="cssbutton" name="ApplyButton" value="提交补打数据" onclick=""></td>
			</tr>
		</table>
	</div>
	</form>
