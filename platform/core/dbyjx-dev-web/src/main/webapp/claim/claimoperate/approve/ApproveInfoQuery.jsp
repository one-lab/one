	...
	<div style="width:100%">
		<table id="QueryCondition" class="common" cellpadding="3" cellspacing="1">
			...
			<tr>
				...
				<td  class="left">授权机构：</td>
				<td  class="right">
					<input class="codecode" id="grantComCode" name="lcReport.grantComCode" class="common" type="text" value="" style="width:20%" ><input name="grantCom" class="common" type="text" onchange="clickable()" style="width:68%" value="">
				</td>
		...
		<table id="QueryResult" class="common" cellpadding="3" cellspacing="0">
			<thead>
				<tr>
					<td class="formtitle" colspan="8"><img src="${ctx}/images/bgformtitle.gif" style="cursor:hand;">查询结果</td>
				</tr>
				<tr class="tableHead">
					<td width="2%">&nbsp;</td>
					<td width="4%">序号</td>
		...
		<table id="PageInfo" class="common" cellpadding="3" cellspacing="0">
			<tr>
				<td>
					<input type="button" class="cssbutton" name = "AppButton" value="申  请" onClick="self.location.href='${ctx}/claim/claimoperate/approve/CaseApprove.jsp'" />
				</td>
			</tr>
		</table>
		<table id="WorkList" class="common" cellpadding="3" cellspacing="0">
			<thead>
				<tr>
					<td class="formtitle" colspan="8"><img src="${ctx}/images/bgformtitle.gif" style="cursor:hand;">个人工作队列</td>
				</tr>
				<tr class="tableHead">
					<td width="2%">&nbsp;</td>
					<td width="4%">序号</td>
			 ...
			 <tbody>
				<tr class="content">
					<td><input type="radio" name="Redio" value="" /></td>
					<td>1</td>
					<td><a href="javascript:void(0)" onclick="self.location.href='${ctx}/claim/claimoperate/approve/CaseApprove.jsp'">S86012012018</a></td>
					<td>审核</td>
					<td>马布</td>
					<td>男</td>
					<td>2012-03-01</td>
