		...
		<table id="PageInfo" class="common" cellpadding="3" cellspacing="0">
			<tr>
				<td>
					...
					<input type="button" class="cssbutton" name="CancelSurvey" value="备注信息" onclick="self.location.href='${ctx}/claim/claimoperate/report/SurveyCancel.jsp'" />
				</td>
			</tr>
			<tr>
				<td>
					...
					<input type="button" class="cssbutton" name="SecAuditResult" value="审核审批结论查看" onclick="self.location.href='${ctx}/claim/claimoperate/audit/DealSecdAudit.jsp'" />
				</td>
			</tr>
		</table>
		<hr />
