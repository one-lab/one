...
<body>
	...
	<div style="width:100%">
		...
		<table id="AdvancePayDeal" class="common" cellpadding="3" cellspacing="0">
			<thead>
				<tr>
					<td class="formtitle" colspan="9"><img src="${ctx}/images/bgformtitle.gif" style="cursor:hand;"/>保项的预付金额的处理</td>
				</tr>
				<tr class="tableHead">
					<td width="2%">&nbsp;</td>
					<td width="4%">序号</td>
		...
		<table id="PageInfo" class="common" cellpadding="3" cellspacing="0">
			<tr>
				<td><input type="button" class="cssbutton" name="delButton" value="删  除" onClick=""/></td>
			</tr>
		</table>
		<hr />
		<table id="BeforeOverViewMain" class="common" cellpadding="3" cellspacing="1">
			<tr>
				...
				<td><input type="button" class="cssbutton" name="saveButton" value="保  存" onClick=""/></td>
			</tr>
		</table>
		<hr />
		...
		<table id="PageInfo" class="common" cellpadding="3" cellspacing="0">
			<tr>
				<td>
					...
					<input type="button" class="cssbutton" name = "saveButton" value="预付确认" onClick="" />
