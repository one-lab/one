...
<body>
	...
	<div style="width:100%">
		<table id="SurveyTaskList" class="common" cellpadding="3" cellspacing="0">
			<thead>
				<tr>
					<td class="formtitle" colspan="8"><img src="${ctx}/images/bgformtitle.gif" style="cursor:hand;">调查任务队列</td>
				</tr>
				<tr class="tableHead">
					<td width="2%">&nbsp;</td>
					<td width="4%">序号</td>
					<td width="17%">报/赔案号</td>
					<td width="17%">调查序号</td>
					<td width="15%">出险人姓名</td>
					<td width="15%">调查发起人</td>
					<td width="15%">调查发起日期</td>
					<td width="15%">管理机构</td>
				</tr>
			</thead>
			<tbody>
