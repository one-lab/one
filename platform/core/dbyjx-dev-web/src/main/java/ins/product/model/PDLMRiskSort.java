 ...
 */
@Entity
@Table(name = "PD_LMRISKSORT")
public class PDLMRiskSort implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMRiskSortId id;
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "riskSortType", column = @Column(name = "RISKSORTTYPE")),
			@AttributeOverride(name = "riskSortValue", column = @Column(name = "RISKSORTVALUE")) })
	public PDLMRiskSortId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMRiskSortId id) {
		this.id = id;
	}
