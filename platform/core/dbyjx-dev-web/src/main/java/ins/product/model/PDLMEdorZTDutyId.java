...
/**
 * POJO类PDLMEdorZTDutyId
 */
@Embeddable
public class PDLMEdorZTDutyId implements java.io.Serializable {
	...
	/**
	 * 类PDLMEdorZTDutyId的默认构造方法
	 */
	public PDLMEdorZTDutyId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PDLMEdorZTDutyId)) {
			return false;
		}
		PDLMEdorZTDutyId castOther = (PDLMEdorZTDutyId) other;
