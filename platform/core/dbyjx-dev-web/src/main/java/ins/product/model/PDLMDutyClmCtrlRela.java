...
/**
 * POJO类PDLMDutyClmCtrlRela
 */
@Entity
@Table(name = "PD_LMDUTYCLMCTRLRELA")
public class PDLMDutyClmCtrlRela implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMDutyClmCtrlRelaId id;
	...
	/**
	 * 类PDLMDutyClmCtrlRela的默认构造方法
	 */
	public PDLMDutyClmCtrlRela() {
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "claimCtrlCode", column = @Column(name = "CLAIMCTRLCODE")),
	...
	public PDLMDutyClmCtrlRelaId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMDutyClmCtrlRelaId id) {
		this.id = id;
	}
