...
/**
 * POJO类PDLMEdorBonusZT
 */
@Entity
@Table(name = "PD_LMEDORBONUSZT")
public class PDLMEdorBonusZT implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMEdorBonusZTId id;
	...
	/**
	 * 类PDLMEdorBonusZT的默认构造方法
	 */
	public PDLMEdorBonusZT() {
	}
	...
	public PDLMEdorBonusZTId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMEdorBonusZTId id) {
		this.id = id;
	}
