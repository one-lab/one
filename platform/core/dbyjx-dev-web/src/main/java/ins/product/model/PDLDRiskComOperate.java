...
/**
 * POJO类PDLDRiskComOperate
 */
@Entity
@Table(name = "PD_LDRISKCOMOPERATE")
public class PDLDRiskComOperate implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLDRiskComOperateId id;
	...
	/**
	 * 类PDLDRiskComOperate的默认构造方法
	 */
	public PDLDRiskComOperate() {
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "manageCom", column = @Column(name = "MANAGECOM")),
			@AttributeOverride(name = "comCode", column = @Column(name = "COMCODE")),
			@AttributeOverride(name = "operateType", column = @Column(name = "OPERATETYPE")) })
	public PDLDRiskComOperateId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLDRiskComOperateId id) {
		this.id = id;
	}
