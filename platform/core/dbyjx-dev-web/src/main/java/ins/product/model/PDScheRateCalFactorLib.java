...
/**
 * POJO类PDScheRateCalFactorLib
 */
@Entity
@Table(name = "PD_SCHERATECALFACTOR_LIB")
public class PDScheRateCalFactorLib implements java.io.Serializable {
	...
	/**
	 * 类PDScheRateCalFactorLib的默认构造方法
	 */
	public PDScheRateCalFactorLib() {
	}
