...
/**
 * POJO类PDTestPointClewLib
 */
@Entity
@Table(name = "PD_TESTPOINTCLEW_LIB")
public class PDTestPointClewLib implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDTestPointClewLibId id;

	/** 属性产品定义基础字段 */
	private PDBaseField PDBaseField;
	...
	/**
	 * 类PDTestPointClewLib的默认构造方法
	 */
	public PDTestPointClewLib() {
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "序号", column = @Column(name = "序号")) })
	public PDTestPointClewLibId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDTestPointClewLibId id) {
		this.id = id;
	}
	...
	@JoinColumns({
			...
			@JoinColumn(name = "FIELDCODE", referencedColumnName = "FIELDCODE", nullable = false, insertable = false, updatable = false) })
	public PDBaseField getPDBaseField() {
		return this.PDBaseField;
	}

	/**
	 * 属性产品定义基础字段的setter方法
	 */
	public void setPDBaseField(PDBaseField PDBaseField) {
		this.PDBaseField = PDBaseField;
	}
	...
	@Column(name = "CLEWCONTENT")
	public String getClewContent() {
		return this.clewContent;
	}

	/**
	 * 属性测试要点提示内容的setter方法
	 */
	public void setClewContent(String clewContent) {
