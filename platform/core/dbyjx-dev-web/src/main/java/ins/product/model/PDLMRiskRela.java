 ...
 */
@Entity
@Table(name = "PD_LMRISKRELA")
public class PDLMRiskRela implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMRiskRelaId id;
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "relaRiskCode", column = @Column(name = "RELARISKCODE")),
			@AttributeOverride(name = "relaCode", column = @Column(name = "RELACODE")),
			@AttributeOverride(name = "manageComGrp", column = @Column(name = "MANAGECOMGRP")) })
	public PDLMRiskRelaId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMRiskRelaId id) {
		this.id = id;
	}

	/**
	 * 属性代扣附加险保费标志的getter方法
	 */

	@Column(name = "DKSUBPREM")
	public String getDkSubPrem() {
		return this.dkSubPrem;
	}

	/**
	 * 属性代扣附加险保费标志的setter方法
	 */
