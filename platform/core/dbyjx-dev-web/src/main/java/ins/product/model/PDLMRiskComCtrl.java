...
/**
 * POJO类PDLMRiskComCtrl
 */
@Entity
@Table(name = "PD_LMRISKCOMCTRL")
public class PDLMRiskComCtrl implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMRiskComCtrlId id;
	...
	/**
	 * 类PDLMRiskComCtrl的默认构造方法
	 */
	public PDLMRiskComCtrl() {
	}
	...
	public PDLMRiskComCtrlId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMRiskComCtrlId id) {
		this.id = id;
	}
	 ...
	 * 属性销售份数上限的setter方法
	 */
	public void setMaxMult(BigDecimal maxMult) {
	 ...
	 * 属性销售份数下限的setter方法
	 */
	public void setMinMult(BigDecimal minMult) {
