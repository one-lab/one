...
/**
 * POJO类PDLMRiskAddAmntId
 */
@Embeddable
public class PDLMRiskAddAmntId implements java.io.Serializable {
	...
	/**
	 * 类PDLMRiskAddAmntId的默认构造方法
	 */
	public PDLMRiskAddAmntId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PDLMRiskAddAmntId)) {
			return false;
		}
		PDLMRiskAddAmntId castOther = (PDLMRiskAddAmntId) other;
