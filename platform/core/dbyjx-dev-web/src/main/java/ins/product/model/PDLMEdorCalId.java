 ...
 */
@Embeddable
public class PDLMEdorCalId implements java.io.Serializable {
	...
	/**
	 * 类PDLMEdorCalId的默认构造方法
	 */
	public PDLMEdorCalId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PDLMEdorCalId)) {
			return false;
		}
		PDLMEdorCalId castOther = (PDLMEdorCalId) other;
		...
		return ((this.getRiskCode() == castOther.getRiskCode()) || (this
				...
				&& ((this.getCalType() == castOther.getCalType()) || (this
						.getCalType() != null && castOther.getCalType() != null && this
						.getCalType().equals(castOther.getCalType())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCalType() == null ? 0 : this.getCalType().hashCode());
		return result;
	}
