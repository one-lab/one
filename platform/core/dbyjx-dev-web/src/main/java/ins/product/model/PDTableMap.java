 ...
 */
@Entity
@Table(name = "PD_TABLEMAP")
public class PDTableMap implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDTableMapId id;
	...
	/** 属性PDFieldMaps */
	private List<PDFieldMap> PDFieldMaps = new ArrayList<PDFieldMap>(0);
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDTableMapId id) {
		this.id = id;
	}
	...
	/**
	 * 属性PDFieldMaps的getter方法
	 */
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "PDTableMap")
	public List<PDFieldMap> getPDFieldMaps() {
		return this.PDFieldMaps;
	}

	/**
	 * 属性PDFieldMaps的setter方法
	 */
	public void setPDFieldMaps(List<PDFieldMap> PDFieldMaps) {
		this.PDFieldMaps = PDFieldMaps;
	}
