...
/**
 * POJO类PDLMDutyGetAliveId
 */
@Embeddable
public class PDLMDutyGetAliveId implements java.io.Serializable {
	...
	/**
	 * 类PDLMDutyGetAliveId的默认构造方法
	 */
	public PDLMDutyGetAliveId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PDLMDutyGetAliveId)) {
			return false;
		}
		PDLMDutyGetAliveId castOther = (PDLMDutyGetAliveId) other;
