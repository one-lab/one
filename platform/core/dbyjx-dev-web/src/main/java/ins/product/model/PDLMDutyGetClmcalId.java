...
/**
 * POJO类PDLMDutyGetClmcalId
 */
@Embeddable
public class PDLMDutyGetClmcalId implements java.io.Serializable {
	...
	/**
	 * 类PDLMDutyGetClmcalId的默认构造方法
	 */
	public PDLMDutyGetClmcalId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PDLMDutyGetClmcalId)) {
			return false;
		}
		PDLMDutyGetClmcalId castOther = (PDLMDutyGetClmcalId) other;
