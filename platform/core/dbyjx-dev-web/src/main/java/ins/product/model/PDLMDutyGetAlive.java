...
/**
 * POJO类PDLMDutyGetAlive
 */
@Entity
@Table(name = "PD_LMDUTYGETALIVE")
public class PDLMDutyGetAlive implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMDutyGetAliveId id;
	...
	/**
	 * 类PDLMDutyGetAlive的默认构造方法
	 */
	public PDLMDutyGetAlive() {
	}
	...
	public PDLMDutyGetAliveId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMDutyGetAliveId id) {
		this.id = id;
	}
