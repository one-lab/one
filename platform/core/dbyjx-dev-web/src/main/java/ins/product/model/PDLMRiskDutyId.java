 ...
 */
@Embeddable
public class PDLMRiskDutyId implements java.io.Serializable {
	...
	/**
	 * 类PDLMRiskDutyId的默认构造方法
	 */
	public PDLMRiskDutyId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PDLMRiskDutyId)) {
			return false;
		}
		PDLMRiskDutyId castOther = (PDLMRiskDutyId) other;
