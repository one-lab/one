 ...
 */
@Entity
@Table(name = "PD_LMRISKBONUS")
public class PDLMRiskBonus implements java.io.Serializable {
	...
	/**
	 * 类PDLMRiskBonus的默认构造方法
	 */
	public PDLMRiskBonus() {
	}
	...
	@Column(name = "BONUSCOEFCODE")
	public String getBonusCoefCode() {
		return this.bonusCoefCode;
	}

	/**
	 * 属性红利系数计算公式的setter方法
	 */
	public void setBonusCoefCode(String bonusCoefCode) {
		this.bonusCoefCode = bonusCoefCode;
	}
	...
	@Column(name = "ADDAMNTCOEFCODE")
	public String getAddAmntCoefCode() {
		return this.addAmntCoefCode;
	}

	/**
	 * 属性增额交清计算公式的setter方法
	 */
	public void setAddAmntCoefCode(String addAmntCoefCode) {
		this.addAmntCoefCode = addAmntCoefCode;
	}
	...
	@Column(name = "BONUSCALSTART")
	public Date getBonusCalStart() {
		return this.bonusCalStart;
	}

	/**
	 * 属性红利有效开始时间的setter方法
	 */
	public void setBonusCalStart(Date bonusCalStart) {
		this.bonusCalStart = bonusCalStart;
	}
	 ...
	 */
	@Temporal(TemporalType.DATE)
	@Column(name = "BONUSCALDEND")
	public Date getBonusCaldEnd() {
		return this.bonusCaldEnd;
	}

	/**
	 * 属性红利有效终止时间的setter方法
	 */
	public void setBonusCaldEnd(Date bonusCaldEnd) {
		this.bonusCaldEnd = bonusCaldEnd;
	}
