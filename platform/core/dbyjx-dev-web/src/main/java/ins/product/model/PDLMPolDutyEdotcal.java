...
/**
 * POJO类PDLMPolDutyEdotcal
 */
@Entity
@Table(name = "PD_LMPOLDUTYEDORCAL")
public class PDLMPolDutyEdotcal implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMPolDutyEdotcalId id;
	...
	/**
	 * 类PDLMPolDutyEdotcal的默认构造方法
	 */
	public PDLMPolDutyEdotcal() {
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "edorType", column = @Column(name = "EDORTYPE")) })
	public PDLMPolDutyEdotcalId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMPolDutyEdotcalId id) {
		this.id = id;
	}
	...
	@Column(name = "CHGPREMCALCODE")
	public String getChgPremCalCode() {
		return this.chgPremCalCode;
	}

	/**
	 * 属性补退保费计算代码的setter方法
	 */
	public void setChgPremCalCode(String chgPremCalCode) {
		this.chgPremCalCode = chgPremCalCode;
	}
	...
	@Column(name = "INTERESTCALCODE")
	public String getInterestCalCode() {
		return this.interestCalCode;
	}

	/**
	 * 属性利息计算算法的setter方法
	 */
	public void setInterestCalCode(String interestCalCode) {
		this.interestCalCode = interestCalCode;
	}
