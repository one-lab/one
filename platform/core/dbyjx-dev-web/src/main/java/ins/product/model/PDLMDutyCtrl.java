 ...
 */
@Entity
@Table(name = "PD_LMDUTYCTRL")
public class PDLMDutyCtrl implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMDutyCtrlId id;
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMDutyCtrlId id) {
		this.id = id;
	}
