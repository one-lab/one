 ...
 */
@Entity
@Table(name = "PD_LMEDORZTDUTY")
public class PDLMEdorZTDuty implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMEdorZTDutyId id;
	...
	/**
	 * 类PDLMEdorZTDuty的默认构造方法
	 */
	public PDLMEdorZTDuty() {
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMEdorZTDutyId id) {
		this.id = id;
	}
	...
	@Column(name = "PAYBYACC")
	public String getPayByAcc() {
		return this.payByAcc;
	}

	/**
	 * 属性是否按账户退保的setter方法
	 */
	public void setPayByAcc(String payByAcc) {
		this.payByAcc = payByAcc;
	}

	/**
	 * 属性是按保费还是保额计算的getter方法
	 */

	@Column(name = "PAYCALTYPE")
	public String getPayCalType() {
		return this.payCalType;
	}

	/**
	 * 属性是按保费还是保额计算的setter方法
	 */
	public void setPayCalType(String payCalType) {
		this.payCalType = payCalType;
	}
