 ...
 */
@Entity
@Table(name = "PD_LMRISKTOACC")
public class PDLMRiskToAcc implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMRiskToAccId id;
	...
	/** 属性PDLMAccGuratRates */
	private List<PDLMAccGuratRate> PDLMAccGuratRates = new ArrayList<PDLMAccGuratRate>(
			0);

	/**
	 * 类PDLMRiskToAcc的默认构造方法
	 */
	public PDLMRiskToAcc() {
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMRiskToAccId id) {
		this.id = id;
	}
	...
	/**
	 * 属性PDLMAccGuratRates的getter方法
	 */
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "PDLMRiskToAcc")
	public List<PDLMAccGuratRate> getPDLMAccGuratRates() {
		return this.PDLMAccGuratRates;
	}

	/**
	 * 属性PDLMAccGuratRates的setter方法
	 */
	public void setPDLMAccGuratRates(List<PDLMAccGuratRate> PDLMAccGuratRates) {
		this.PDLMAccGuratRates = PDLMAccGuratRates;
	}
