 ...
 */
@Entity
@Table(name = "PD_LMEDORCAL")
public class PDLMEdorCal implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMEdorCalId id;
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "calType", column = @Column(name = "CALTYPE")) })
	public PDLMEdorCalId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMEdorCalId id) {
		this.id = id;
	}
	...
	@Column(name = "CALDESCIBE")
	public String getCalDescibe() {
		return this.calDescibe;
	}
