 ...
 */
@Entity
@Table(name = "PD_LMDUTYGETCLM")
public class PDLMDutyGetClm implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMDutyGetClmId id;
	...
	/**
	 * 类PDLMDutyGetClm的默认构造方法
	 */
	public PDLMDutyGetClm() {
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMDutyGetClmId id) {
		this.id = id;
	}
