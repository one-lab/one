...
/**
 * POJO类PDLMRiskAddAmnt
 */
@Entity
@Table(name = "PD_LMRISKADDAMNT")
public class PDLMRiskAddAmnt implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PDLMRiskAddAmntId id;

	/** 属性递增范围 */
	private String addRange;

	/** 属性递增算法 */
	private String addCalCode;
	...
	/**
	 * 类PDLMRiskAddAmnt的默认构造方法
	 */
	public PDLMRiskAddAmnt() {
	}
	...
	public PDLMRiskAddAmntId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PDLMRiskAddAmntId id) {
		this.id = id;
	}
	...
	@Column(name = "ADDCALCODE")
	public String getAddCalCode() {
		return this.addCalCode;
	}

	/**
	 * 属性递增算法的setter方法
	 */
	public void setAddCalCode(String addCalCode) {
		this.addCalCode = addCalCode;
	}
