 ...
 */
@Entity
@Table(name = "PD_LMDUTYPAY_LIB")
public class PDLMDutyPayLib implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性责任缴费库代码 */
	private String payPlanCode2;
	...
	/**
	 * 类PDLMDutyPayLib的默认构造方法
	 */
	public PDLMDutyPayLib() {
	}
	 ...
	 */
	@Id
	@Column(name = "PAYPLANCODE2")
	public String getPayPlanCode2() {
		return this.payPlanCode2;
	}

	/**
	 * 属性责任缴费库代码的setter方法
	 */
	public void setPayPlanCode2(String payPlanCode2) {
		this.payPlanCode2 = payPlanCode2;
	}
