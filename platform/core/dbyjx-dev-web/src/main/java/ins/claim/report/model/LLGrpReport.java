 ...
 */
@Entity
@Table(name = "LLGRPREPORT")
public class LLGrpReport implements java.io.Serializable {
	...
	/** 属性不受理原因 */
	private String noAcceptDesc;

	/** 属性委托标志 */
	private String grpEntrustSign;

	/** 属性委托机构 */
	private String grpEntrustMngCom;

	/** 属性团体承保机构 */
	private String grpAccMngCom;
	...
	/** 属性委托机构名称 */
	private String grpEntrustMngComValue;
	...
	@Column(name = "RGTCONCLUSION")
	public String getRgtConclusion() {
		return this.rgtConclusion;
	}

	/**
	 * 属性立案结论的setter方法
	 */
	public void setRgtConclusion(String rgtConclusion) {
		this.rgtConclusion = rgtConclusion;
	}
	...
	@Column(name = "NOACCEPTDESC")
	public String getNoAcceptDesc() {
		return this.noAcceptDesc;
	}

	/**
	 * 属性不受理原因的setter方法
	 */
	public void setNoAcceptDesc(String noAcceptDesc) {
		this.noAcceptDesc = noAcceptDesc;
	}
	...
	@Column(name = "GRPENTRUSTSIGN")
	public String getGrpEntrustSign() {
		return this.grpEntrustSign;
	}

	/**
	 * 属性委托标志的setter方法
	 */
	public void setGrpEntrustSign(String grpEntrustSign) {
		this.grpEntrustSign = grpEntrustSign;
	}
	...
	@Column(name = "GRPENTRUSTMNGCOM")
	public String getGrpEntrustMngCom() {
		return this.grpEntrustMngCom;
	}

	/**
	 * 属性委托机构的setter方法
	 */
	public void setGrpEntrustMngCom(String grpEntrustMngCom) {
		this.grpEntrustMngCom = grpEntrustMngCom;
	}
	...
	@Column(name = "GRPACCMNGCOM")
	public String getGrpAccMngCom() {
		return this.grpAccMngCom;
	}

	/**
	 * 属性团体承保机构的setter方法
	 */
	public void setGrpAccMngCom(String grpAccMngCom) {
		this.grpAccMngCom = grpAccMngCom;
	}
	...
	@Column(name = "GRPENTRUSTMNGCOMVALUE")
	public String getGrpEntrustMngComValue() {
		return this.grpEntrustMngComValue;
	}

	/**
	 * 属性委托机构名称的setter方法
	 */
	public void setGrpEntrustMngComValue(String grpEntrustMngComValue) {
		this.grpEntrustMngComValue = grpEntrustMngComValue;
	}
