 ...
 */
@Entity
@Table(name = "LCGRPPOLREPORT")
public class LCGrpPolReport implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性ID */
	private LCGrpPolReportId id;
	...
	/**
	 * 类LCGrpPolReport的默认构造方法
	 */
	public LCGrpPolReport() {
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "grpPolNo", column = @Column(name = "GRPPOLNO")) })
	public LCGrpPolReportId getId() {
		return this.id;
	}
	 ...
	 * 属性ID的setter方法
	 */
	public void setId(LCGrpPolReportId id) {
		this.id = id;
	}
