 ...
 */
@Embeddable
public class LCGrpRepInfoId implements java.io.Serializable {
	...
	/**
	 * 类LCGrpRepInfoId的默认构造方法
	 */
	public LCGrpRepInfoId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof LCGrpRepInfoId)) {
			return false;
		}
		LCGrpRepInfoId castOther = (LCGrpRepInfoId) other;
