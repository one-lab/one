...
/**
 * POJO类LCActuarialAuditId
 */
@Embeddable
public class LCActuarialAuditId implements java.io.Serializable {
	...
	/**
	 * 类LCActuarialAuditId的默认构造方法
	 */
	public LCActuarialAuditId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof LCActuarialAuditId)) {
			return false;
		}
		LCActuarialAuditId castOther = (LCActuarialAuditId) other;
