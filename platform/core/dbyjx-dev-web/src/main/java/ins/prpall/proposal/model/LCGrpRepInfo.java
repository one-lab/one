 ...
 */
@Entity
@Table(name = "LCGRPREPINFO")
public class LCGrpRepInfo implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private LCGrpRepInfoId id;
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(LCGrpRepInfoId id) {
		this.id = id;
	}
