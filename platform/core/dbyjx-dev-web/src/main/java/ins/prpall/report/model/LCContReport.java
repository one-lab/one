 ...
 */
@Entity
@Table(name = "LCCONTREPORT")
public class LCContReport implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性ID */
	private LCContReportId id;
	 ...
	 * 属性ID的setter方法
	 */
	public void setId(LCContReportId id) {
		this.id = id;
	}
