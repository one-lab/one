...
/**
 * POJO类LCContPlanDutyParamId
 */
@Embeddable
public class LCContPlanDutyParamId implements java.io.Serializable {
	...
	/**
	 * 类LCContPlanDutyParamId的默认构造方法
	 */
	public LCContPlanDutyParamId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof LCContPlanDutyParamId)) {
			return false;
		}
		LCContPlanDutyParamId castOther = (LCContPlanDutyParamId) other;
