 ...
 */
@Entity
@Table(name = "LCSEARCHINFO")
public class LCSearchInfo implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private LCSearchInfoId id;
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(LCSearchInfoId id) {
		this.id = id;
	}
