 ...
 */
@Entity
@Table(name = "LDPERSONREPORT")
public class LDPersonReport implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private LDPersonReportId id;
	...
	/**
	 * 类LDPersonReport的默认构造方法
	 */
	public LDPersonReport() {
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(LDPersonReportId id) {
		this.id = id;
	}
