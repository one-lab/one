...
/**
 * POJO类LCRepInfoReportDetail
 */
@Entity
@Table(name = "LCREPINFOREPORTDETAIL")
public class LCRepInfoReportDetail implements java.io.Serializable {
	...
	/**
	 * 类LCRepInfoReportDetail的默认构造方法
	 */
	public LCRepInfoReportDetail() {
	}
