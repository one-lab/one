...
/**
 * POJO类LCInsuredReport
 */
@Entity
@Table(name = "LCINSUREDREPORT")
public class LCInsuredReport implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private LCInsuredReportId id;
	...
	/**
	 * 类LCInsuredReport的默认构造方法
	 */
	public LCInsuredReport() {
	}
	...
	public LCInsuredReportId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(LCInsuredReportId id) {
		this.id = id;
	}
