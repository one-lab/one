 ...
 */
@Entity
@Table(name = "LDGRPREPORT")
public class LDGrpReport implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性ID */
	private LDGrpReportId id;
	 ...
	 * 属性ID的setter方法
	 */
	public void setId(LDGrpReportId id) {
		this.id = id;
	}
