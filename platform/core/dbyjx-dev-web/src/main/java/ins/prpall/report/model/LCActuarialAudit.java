...
/**
 * POJO类LCActuarialAudit
 */
@Entity
@Table(name = "LCACTUARIALAUDIT")
public class LCActuarialAudit implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private LCActuarialAuditId id;
	...
	/**
	 * 类LCActuarialAudit的默认构造方法
	 */
	public LCActuarialAudit() {
	}
	...
	public LCActuarialAuditId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(LCActuarialAuditId id) {
		this.id = id;
	}
