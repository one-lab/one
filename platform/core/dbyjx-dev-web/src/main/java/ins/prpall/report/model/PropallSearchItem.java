...
/**
 * POJO类PropallSearchItem
 */
@Entity
@Table(name = "PROPALLSEARCHITEM")
public class PropallSearchItem implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性序号 */
	private PropallSearchItemId id;
	...
	/**
	 * 类PropallSearchItem的默认构造方法
	 */
	public PropallSearchItem() {
	}
	...
	public PropallSearchItemId getId() {
		return this.id;
	}
	 ...
	 * 属性序号的setter方法
	 */
	public void setId(PropallSearchItemId id) {
		this.id = id;
	}
