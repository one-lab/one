...
/**
 * POJO类LCReportAuditId
 */
@Embeddable
public class LCReportAuditId implements java.io.Serializable {
	...
	/**
	 * 类LCReportAuditId的默认构造方法
	 */
	public LCReportAuditId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof LCReportAuditId)) {
			return false;
		}
		LCReportAuditId castOther = (LCReportAuditId) other;
