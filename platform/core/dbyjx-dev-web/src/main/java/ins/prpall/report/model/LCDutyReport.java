 ...
 */
@Entity
@Table(name = "LCDUTYREPORT")
public class LCDutyReport implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性ID */
	private LCDutyReportId id;
	 ...
	 * 属性ID的setter方法
	 */
	public void setId(LCDutyReportId id) {
		this.id = id;
	}
