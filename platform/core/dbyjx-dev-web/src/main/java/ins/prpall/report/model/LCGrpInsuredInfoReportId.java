...
/**
 * POJO类LCGrpInsuredInfoReportId
 */
@Embeddable
public class LCGrpInsuredInfoReportId implements java.io.Serializable {
	...
	/**
	 * 类LCGrpInsuredInfoReportId的默认构造方法
	 */
	public LCGrpInsuredInfoReportId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof LCGrpInsuredInfoReportId)) {
			return false;
		}
		LCGrpInsuredInfoReportId castOther = (LCGrpInsuredInfoReportId) other;
