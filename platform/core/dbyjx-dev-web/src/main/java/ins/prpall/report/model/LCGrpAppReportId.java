...
/**
 * POJO类LCGrpAppReportId
 */
@Embeddable
public class LCGrpAppReportId implements java.io.Serializable {
	...
	/**
	 * 类LCGrpAppReportId的默认构造方法
	 */
	public LCGrpAppReportId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof LCGrpAppReportId)) {
			return false;
		}
		LCGrpAppReportId castOther = (LCGrpAppReportId) other;
