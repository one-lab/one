...
/**
 * POJO类LCGrpContReport
 */
@Entity
@Table(name = "LCGRPCONTREPORT")
public class LCGrpContReport implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性ID */
	private LCGrpContReportId id;
	...
	/**
	 * 类LCGrpContReport的默认构造方法
	 */
	public LCGrpContReport() {
	}
	...
	public LCGrpContReportId getId() {
		return this.id;
	}
	 ...
	 * 属性ID的setter方法
	 */
	public void setId(LCGrpContReportId id) {
		this.id = id;
	}
