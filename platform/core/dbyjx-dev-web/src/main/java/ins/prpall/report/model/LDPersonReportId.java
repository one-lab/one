...
/**
 * POJO类LDPersonReportId
 */
@Embeddable
public class LDPersonReportId implements java.io.Serializable {
	...
	/**
	 * 类LDPersonReportId的默认构造方法
	 */
	public LDPersonReportId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof LDPersonReportId)) {
			return false;
		}
		LDPersonReportId castOther = (LDPersonReportId) other;
