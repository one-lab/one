 ...
 */
@Entity
@Table(name = "LCPOLREPORT")
public class LCPolReport implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性ID */
	private LCPolReportId id;
	 ...
	 * 属性ID的setter方法
	 */
	public void setId(LCPolReportId id) {
		this.id = id;
	}
