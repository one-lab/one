package com.sinosoft.one.mvc.testcases.web.impl.thread;
...
import com.sinosoft.one.mvc.mock.controllers.methodparameter.MethodParameter2Controller;
import com.sinosoft.one.mvc.mock.controllers.methodparameter.MethodParameter2Controller.User;
...
public class MethodParameterResolverTest extends AbstractControllerTest {
    ...
    public void testUserBean2() throws Exception {
        ...
        request.addParameter("ua.name", "mvc");
    ...
    protected Object[] resolveMethodParameters(String methodName) throws Exception {
        ...
        invoke(uri, "GET", "");
        Invocation inv = (Invocation) request.getAttribute("$$one-mvc.invocation");
