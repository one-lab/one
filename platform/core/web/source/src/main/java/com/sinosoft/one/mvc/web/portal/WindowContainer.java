...
import com.sinosoft.one.mvc.web.portal.impl.PipeResolver;
import com.sinosoft.one.mvc.web.portal.impl.PortalResolver;
 ...
 * <p>
 * 
 * <strong>*mvc和portal/pipe的关系*</strong>
 * 
 * <pre>
 * 1、mvc是一个应用于web开发框架，portal/pipe不是mvc的核心，只是mvc的一个插件；
 * 3、portal/pipe使用mvc开放出来的spring“配置文件”插入到mvc框架中，使得portal/pipe可以在mvc的程序中使用；
 * </pre>
 * 
 ...
 * 2、mvc框架提供了 {@link ParamResolver}接口，portal/pipe提供了该接口的实现 {@link PortalResolver} / {@link PipeResolver}，并配置到 jar 包中的 applicatonContext*.xml，使得mvc框架能够识别
...
public interface WindowContainer {
     ...
     * pipe则会将窗口的内容转化为符合mvcpipe.js规范的一个script串
     * 
     * @param render
     */
