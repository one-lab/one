...
import com.sinosoft.one.mvc.web.portal.WindowListenerAdapter;
...
public class PipeImpl extends GenericWindowContainer implements Pipe {
    ...
    public static final String WINDIW_JS = "$$one-mvc-portal.pipe.js";

    public static final String WINDOW_CSS = "$$one-mvc-portal.pipe.css";
