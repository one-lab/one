...
public class TaskServiceSpringImpl<T, E> extends GenericDaoHibernate<Task, String>
	...
	public void addTask(String taskId, String name, String menuURL,
			String menuName, String des, String parentId,Employe loginUser,
			String SysFlag) {
		Task task=new Task();
		...
		taskAuth.setComCode(loginUser.getCompany().getComCode());
		taskAuth.setOperateUser(loginUser.getUserCode());
		taskAuth.setTask(task);
	...
	public void updateTask(String taskId, String name, String menuURL,String isValidate,
			String menuName, String des, Employe loginUser,
			String SysFlag) {
