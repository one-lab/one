...
<body>
<form id="updatafm"  action="${ctx }/rms/group/save.do" method="post"  >
            ...
            <table width="97%" border="0" cellspacing="0" cellpadding="0">
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="18%" align="center" class="size4">用户组名称：</td>
                   	<s:if test='group.name !="默认用户组"'>
                    <td width="30%" class="size4-1">
                   		<input id="groupID" name="group.groupID" type="hidden" class="input2" value="${group.groupID}">
                    	<input id="groupComCode" type="hidden" class="input2" value="${group.comCode}">
                    	<input id="groupname" name="group.name" type="text" class="input2" value="${group.name}">
                    </td>
                   	...
                   	<td width="30%" class="size4-1">
                   		<input id="groupID" name="group.groupID" type="hidden" class="input2" value="${group.groupID}">
                    	<input id="groupComCode" type="hidden" class="input2" value="${group.comCode}">
                    	<input id="groupname" disabled="disabled" name="group.name"  type="text" class="input2" value="${group.name}">
                   	 </td>
                   	 <td width="18%" align="right" class="size4"> 用户组描述:</td>
                   	<td class="size4-1"><input disabled="disabled" id="groupdes" name="group.des" type="text" class="input2" value="${group.des}"></td>
                   	</s:if>
              ...
              <c:forEach var="roleDesignate" items="${roleDesignates}" varStatus="status">
                  <tr>
                    ...
                    <s:if test='group.name =="默认用户组"'>
                    	<td class="td5"><input disabled="disabled" type="checkbox" name="roleIDs" value="${roleDesignate.role.roleID}"></td>
                    </s:if>
                    	<td class="td5">${roleDesignate.role.name }</a></td>
              ...
              <tr id="div3">
                ...
                <a style="margin-left: 90px;font-size: 15px;" href="#" onclick="findGroupUser('${group.groupID}');">点击查看组成员</a>
                <input type="hidden" id="div4ShowType" value="0"/>
                </td>
              </tr>
              <tr >
              	<td width="100%">
              		<div style="float: left;margin-left: 15px;" id="div4" >
              		
              		</div>
              		<div style="float: left; margin-left: 100px;" id="div5">
              ...
              <tr id="div5" >
                <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                    <td  class="size4-1"  width="50%" align="center"><input id="updata" style="" type="button" onclick="updataGroup();" class="btn1" value="确定"    ></td>
                    <td  class="size4-1" width="50%" align="center"><input  type="button" style="" class="btn1" onclick="redirect();" value="返 回" ></td>
                  </tr>
                </table></td>
              </tr>
...
<script>
<c:forEach var="role" items="${onRoles}" varStatus="status">
$('input[type="checkbox"][name="roleIDs"][value="${role.roleID}"]').attr('checked',true);
</c:forEach>
</script>