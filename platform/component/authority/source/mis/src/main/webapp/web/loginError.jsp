...
function getmessage() {
    ...
    if (s > 1) {
        ...
        setTimeout(getmessage, 1000);
	   	...
	   	window.location.href = contextRootPath+ "/web/login.jsp";
    };
    //alert(s);
};
											...
											<tr>
												<td align="center" height="20px;">   
													<div style="padding-top:25px;">
    					  								<span style=" font-size:25px;">登陆失效或则未登录</span><br>
    					  								<span  style=" font-size: 17px;"  id="message">5</span> 
    					  								<span style=" font-size: 17px;" >秒后自动跳转…</span><br>
    					  								<span style=" font-size: 17px;" >或者<a href="${ctx}/web/login.jsp" style="font-size: 20px;">点击</a>登陆</span>
    					  							</div>
    					  						</td>
											</tr>			
    					  					<tr>
