...
<link href="${ctx}/static/platform.css" type="text/css" rel="stylesheet" />
<link href="${ctx}/static/window/sinosoft.window.css" type="text/css" rel="stylesheet" />
<script src="${ctx}/static/jquery/1.7.1/jquery-1.7.1.js" type="text/javascript"></script>
