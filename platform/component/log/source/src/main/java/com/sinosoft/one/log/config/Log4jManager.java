...
import com.sinosoft.one.log.queue.QueueAppender;
...
public class Log4jManager {
	 ...
	 */
	public static final String MBEAN_NAME = "log:name=Log4j";

	private static org.slf4j.Logger managerLogger = LoggerFactory.getLogger(Log4jManager.class);

    private static Enumeration allAppenders = null;

    private static boolean fileAppender;

    private static boolean queueAppender;
    ...
    private static void initLoggerAppender() {
        ...
        while (allAppenders.hasMoreElements()) {
            ...
            if(appender instanceof FileAppender) {
                fileAppender = true;
            } else if(appender instanceof QueueAppender) {
                queueAppender = true;
            }
        }
    }
