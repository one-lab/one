...
package com.sinosoft.one.sqlparser.statement.update;
...
public class Update implements Statement {
	...
	/**
	 * The {@link com.sinosoft.one.sqlparser.schema.Column}s in this update (as col1 and col2 in UPDATE col1='a', col2='b')
