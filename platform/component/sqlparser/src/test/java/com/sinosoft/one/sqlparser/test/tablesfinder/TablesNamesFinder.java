package com.sinosoft.one.sqlparser.test.tablesfinder;
...
public class TablesNamesFinder implements SelectVisitor, FromItemVisitor, ExpressionVisitor, ItemsListVisitor {
	...
	/* (non-Javadoc)
	 * @see com.sinosoft.one.sqlparser.expression.ExpressionVisitor#visit(com.sinosoft.one.sqlparser.expression.CaseExpression)
	 */
	...
	/* (non-Javadoc)
	 * @see com.sinosoft.one.sqlparser.expression.ExpressionVisitor#visit(com.sinosoft.one.sqlparser.expression.WhenClause)
	 */
