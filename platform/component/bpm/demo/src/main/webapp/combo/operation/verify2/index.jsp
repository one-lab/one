...
<frameset id="fraTop" rows="200,25,*,40,0" border="0" frameborder="no" framespacing="0">
	<frame name="fraSearchForm" src="${ctx}/combo/operation/verify2/frmSearch.jsp" frameborder="0" scrolling="no" noresize></frame>
	<frame name="fraToolbar" src="${ctx}/combo/operation/verify2/toolbar.jsp" frameborder="0" scrolling="no" noresize></frame>
