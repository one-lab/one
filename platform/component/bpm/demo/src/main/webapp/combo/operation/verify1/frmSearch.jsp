...
<body topmargin="0" leftmargin="0">
	<div class="select_header_top_bg">
		...
		<div class="select_header_top_title">
			<div class="select_header_top_title_content" style="width:180px;">套餐审核一</div>
		</div>
		<div class="select_header_top_right1"></div>
		<div class="select_header_top_right2"></div>
	</div>
	<div class="table_content">
		<form id="frmInput" name="frmInput" action="${ctx}/combo/getVerify1Combos.do" method="get" target="fraSearchList">
					...
					<td colspan="4" align="right">
						<table>
							<tr>
								...
								<td class="btnBigOnFocus"   nowrap><input type="submit" value="查询待审核套餐"></td>
