...
<body>
    ...
    <form action="/demo/uncrypto" method="post">
        <input type="hidden" name="uncryptos_param_name" value="data,user.id,user.name,a.b.c.d,role[0].age"/>
        <input name="name" />
        <input name="data" />
        <input name="user.id" value="${user.id}" />
        <input name="user.name" value="${user.name}" />
        <input name="group.name" />
        <input name="role[0].age" />
        <input name="a.b.c.d" /><br/>
