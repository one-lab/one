...
<head>
    ...
    <link href="${ctx}/static/css/sinosoft.accordion.css" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" src="${ctx}/static/js/sinosoft.accordion.js"></script>
...
<div id="layout_top">
    <div class="header">
        <img src="${ctx}/static/images/system/logo.gif" class="logo"  />
        <p class="user_bar">
            用户：系统管理员
            <a href="changePass.html" class="pass" onclick="return  changePass(this)">修改密码</a>
            <a href="${ctx}/login" class="quit">重新登录</a>
        </p>
    </div>
</div>
...
<div id="layout_left">
    <div class="left_bar">
        ...
        <div id="leftMenu">
            ...
            <div>
                <ul class="nav" id="nav">
                    <li><a href="${ctx}/views/account/loadTask.jsp"><span>功能菜单管理</span></a></li>
                    <li><a href="${ctx}/views/account/loadtaskAuth.jsp"><span>功能授权</span></a></li>
                    <li><a href="${ctx}/views/account/loadRole.jsp"><span>角色管理</span></a>
                        <ul>
                            <li><a href="${ctx}/views/account/loadroleDesignate.jsp"><span>角色指派</span></a></li>
                        </ul>
                    </li>
                    <li><a href="${ctx}/views/account/loadGroup.jsp"><span>用户组管理</span></a></li>
                    <li><a href="${ctx}/views/account/loadEmployeesConfig.jsp"><span>人员配置</span></a></li>
                </ul>
            </div>
        </div>
    </div>
