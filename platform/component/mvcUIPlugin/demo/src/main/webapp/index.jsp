...
<!DOCTYPE jsp PUBLIC "-//W3C//DTD Xjsp 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        ...
        <div id="leftMenu">
            ...
            <div>
            	<ul class="nav" id="nav">
                    ...
                    <li><a href="${ctx}/views/json/loadRole.jsp"><span>角色管理</span></a>
                    	<ul>
                        	<li><a href="${ctx}/views/json/loadroleDesignate.jsp"><span>角色指派</span></a></li>
                        </ul>
                    </li>
                    <li><a href="${ctx}/views/json/loadGroup.jsp"><span>用户组管理</span></a></li>
                    <li><a href="${ctx}/views/json/loadEmployeesConfig.jsp"><span>人员配置</span></a></li>
                </ul>
            </div>        	
        </div>
	</div>
